...
public class ArbolBinario<T> {
    ...
    public ArbolBinario(nodoBST<T> raiz) {
        this.raiz = raiz;
    }
    ...
    public ArbolBinario<T> getSubArbolIzquierda() {
        return new ArbolBinario<>(this.raiz.getIzquierda());
    }

    public ArbolBinario<T> getSubArbolDerecha() {
        return new ArbolBinario<>(this.raiz.getDerecha());
    }
    ...
    private Boolean isArbolCasiCompletoAux1(ListaDE<nodoBST<T>> lista) {
        ...
        ArbolBinario<T> arbolNodo = new ArbolBinario<>(lista.getPrimero().getData());
    ...
    private Boolean isArbolCasiCompletoAux2(ListaDE<nodoBST<T>> lista) {
        ...
        ArbolBinario<T> arbolNodo = new ArbolBinario<>(lista.getPrimero().getData().getDato());
